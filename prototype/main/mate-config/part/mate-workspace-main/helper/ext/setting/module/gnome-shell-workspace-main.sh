...
mate_workspace_main_var_init () {
	...
	THE_MATE_WORKSPACE_MAIN_GSCHEMA_OVERRIDE_FILE_NAME="50_gnome-shell-workspace-main.gschema.override"

	THE_MATE_WORKSPACE_MAIN_SOURCE_GSCHEMA_OVERRIDE_FILE_PATH="${THE_SOURCE_GSCHEMA_DIR_PATH}/${THE_MATE_WORKSPACE_MAIN_GSCHEMA_OVERRIDE_FILE_NAME}"
	THE_MATE_WORKSPACE_MAIN_TARGET_GSCHEMA_OVERRIDE_FILE_PATH="${THE_TARGET_GSCHEMA_DIR_PATH}/${THE_MATE_WORKSPACE_MAIN_GSCHEMA_OVERRIDE_FILE_NAME}"
...
mate_workspace_main_var_dump () {
	...
	util_debug_echo "THE_MATE_WORKSPACE_MAIN_GSCHEMA_OVERRIDE_FILE_NAME=${THE_MATE_WORKSPACE_MAIN_GSCHEMA_OVERRIDE_FILE_NAME}"
	util_debug_echo

	util_debug_echo "THE_MATE_WORKSPACE_MAIN_SOURCE_GSCHEMA_OVERRIDE_FILE_PATH=${THE_MATE_WORKSPACE_MAIN_SOURCE_GSCHEMA_OVERRIDE_FILE_PATH}"
	util_debug_echo "THE_MATE_WORKSPACE_MAIN_TARGET_GSCHEMA_OVERRIDE_FILE_PATH=${THE_MATE_WORKSPACE_MAIN_TARGET_GSCHEMA_OVERRIDE_FILE_PATH}"
	util_debug_echo
...
mate_workspace_main_gschema_put_all () {
	...
	local target_gschema_override_file_path="${THE_MATE_WORKSPACE_MAIN_TARGET_GSCHEMA_OVERRIDE_FILE_PATH}"
